                ...
                <div class="css-nwen1v">
                    <div class="css-uqeajf">
                        <div class="css-1mo5975">
                            <button on:click={()=> goto(`${$url === "/" ? "" : $url}/?tab=auth&modal=login`)} class=" {pageTab === "login" ? "css-ak6yid" : "css-1otg8po"}">Login</button>
                            <button on:click={()=> goto(`${$url === "/" ? "" : $url}/?tab=auth&modal=signup`)} class="{pageTab === "signup" ? "css-ak6yid" : "css-1otg8po"}">Register</button>
                        </div>
                    </div>
                    {#if pageTab === "signup"}
                        <Signup />
