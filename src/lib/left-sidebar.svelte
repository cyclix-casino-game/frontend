    ...
    <div class="css-ubfyk9">
        ...
        <div class="css-1q1bjed">
                ...
                {#each $publicChat as chat}
                    <div class="css-1deqcht">
                        <div class="css-1lphp3s" size="14">
                            <div size="21" class="css-1f0zcjv">
                                <img src="{badge}" alt="" scale="0.96" class="css-zipauw"></div>
                                <div class="css-o3tivt" style="color: white; font-weight: 600;">{chat.profile?.username}:</div>
                            </div>
                ...
                <div class="css-14c5l9t">
                    <div class="rollbit-chat-input rollbit-chat-input--multiLine" style=" ">
                        <div class="rollbit-chat-input__control">
                            ...
                            <textarea autocomplete="off" bind:value={chatMessage} placeholder="{$isLoggin ? "Say something..." : "Log in to chat"}" readonly={$isLoggin ? false : true} class="rollbit-chat-input__input" style="display: block; width: 100%; position: absolute; margin: 0px; top: 0px; left: 0px; box-sizing: border-box; background-color: transparent; font-family: inherit; font-size: 11px; letter-spacing: inherit; padding:10px; height: 100%; bottom: 0px; overflow: hidden; resize: none;"></textarea>
                        </div>
                    </div>
                </div>
            </label>
            ...
            <div class="css-7vf9my">
                ...
                <div class="css-dnlyp1">Rules</div>
                <div class="css-1r39q8v">200</div>
                <button class="css-njm7gi" disabled="{$isLoggin && chatMessage ? false : true}">Send</button>
            </div>
        </div>
    </div>
</div>
