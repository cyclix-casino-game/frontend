...
{#if rules}
    <div id="rollbit-modal-popover-container">
        <div class="css-1nfl9e5" style="height: 296.562px; max-height: 296.562px; bottom: 6%; right: 5%;">
            <div class="css-rymlxq"><ul class="css-8sz5vj">
...
{#if settings}
<div id="rollbit-modal-popover-container">
    <div class="css-den4gc" style="height: 56px; max-height: 56px; top: 842.5px; right: 5%;">
            ...
            <div style="padding: 20px;">
                <div>
                    ...
                    <label for="proof-checkbox-22130" class="css-ep1r8t">
                        ...
                        <div>Show mention notifications<div style="font-size: 12px;">when chat is closed</div></div>
                    </label>
                </div>
            </div>
        </div>
