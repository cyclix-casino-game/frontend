...
<div class="css-uqeajf">
    <div class="css-1mo5975">
        <div class="css-1otg8po">BTC</div>
        <div class="css-1otg8po">ETH</div>
        <div class="css-1otg8po">LTC</div>
        <div class="css-1otg8po">SOL</div>
        <div class="css-1otg8po">TRX</div>
        <div class="css-ak6yid">USDT</div>
    </div>
